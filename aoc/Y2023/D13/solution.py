...
def solve(input_data):
    input_grids = [[line.strip() for line in input_grid.splitlines()] for input_grid in input_data.split('\n\n')]

    return part(input_grids, 1), part(input_grids, 2)
